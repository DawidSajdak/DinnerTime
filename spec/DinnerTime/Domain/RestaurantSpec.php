...
class RestaurantSpec extends ObjectBehavior
{
    function let()
    {
        ...
        $this->beConstructedWith(new RestaurantId(), "Mała Chatka", $address);
    }
    ...
    function it_throw_exception_when_restaurant_name_is_not_a_string()
    {
        ...
        $this->shouldThrow(new InvalidArgumentException("Restaurant name must be a valid string."))->during("__construct", [new RestaurantId(), 123, $address]);
    }
    ...
    function it_throw_exception_when_restaurant_name_has_less_than_three_letters()
    {
        ...
        $this->shouldThrow(new InvalidArgumentException("Restaurant name must have at least 3 letters."))->during("__construct", [new RestaurantId(), "a", $address]);
    }
    ...
    public function it_should_successfully_add_new_menu_card(MenuCard $menuCard)
    {
        ...
        $this->getMenuCardList()->shouldBeAnInstanceOf("DinnerTime\\Domain\\ArrayCollection");
